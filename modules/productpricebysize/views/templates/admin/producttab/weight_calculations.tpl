...
<div id="weight-calculations-wrapper">

	<div class="" style="padding:0 15px;">
		<div class="form-group row" style="margin:20px 0;">
			<label class="control-label col-lg-2">
				{l s='Weight calculations Enabled' mod='productpricebysize'}
			</label>
			<div class="col-lg-10">
				<input data-toggle="switch" class="" id="weight_calculation_enabled" name="weight_calculation_enabled" data-inverse="true" type="checkbox" value="1" {if $ppbs_product->weight_calculation_enabled eq "1"}checked{/if} />
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="form-equation">
				<div id="ppbs-weight-calculator">placeholder 2</div>
			</div>
		</div>
	</div>
</div>
