...
class AdminNewProductPushNotificationController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->toolbar_title = $this->l('Manage Product Notification');
    }
    ...
    public function processSave()
    {
        ...
        $fields = array(
            ...
            'idNotificationType' => WkPwaPushNotification::NEW_PRODUCT_NOTIFICATION,
            'title' => $title,
            'body' => $body,
