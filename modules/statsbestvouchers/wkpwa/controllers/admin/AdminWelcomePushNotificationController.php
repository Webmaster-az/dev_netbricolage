...
class AdminWelcomePushNotificationController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->toolbar_title = $this->l('Manage Welcome Notification');
    }
    ...
    public function processSave()
    {
        ...
        $fields = array(
            ...
            'idNotificationType' => WkPwaPushNotification::WELCOME_NOTIFICATION,
            'title' => $title,
            'body' => $body,
