...
$stylestars = Configuration::get($_name.'stylestars');
...
if (version_compare(_PS_VERSION_, '1.5', '<')){
    ...
    setcookie_gsnipreview(array('codev'=>$codev,'type'=>'abuse'));
} else{
	$cookie = Context::getContext()->cookie;
    $cookie = new Cookie($_name);
    $cookie->abuse_code_gsnipreview = $codev;
}
...
for ($i = 0; $i < Tools::strlen($codev); $i++) {
    ...
    imagecolorallocate($char, $red, $green, $blue)
