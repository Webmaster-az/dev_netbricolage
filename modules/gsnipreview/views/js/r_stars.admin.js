...
function put_stars(div, rating)
{
	...
	for (var j = 0; j < NUMBER_OF_STARS; j++)
	{
	    ...
	    star.setAttribute('src', module_dir_admin+'views/img/'+gsnipreview_star_active);
	    ...
	    {
	        star.setAttribute('src', module_dir_admin+'views/img/'+gsnipreview_star_noactive);
	        star.className = 'off';
	...
	function rating_review_shop(obj,rating_value){
	  ...
	  for(var i=1; i<=5; i++){
	   if(i<=rating_value){
	    ...
	    _img.src = module_dir_admin+'views/img/'+gsnipreview_star_active;
	   }else{
	    _img = document.getElementById('img_'+obj+'_'+i);
	    _img.src = module_dir_admin+'views/img/'+gsnipreview_star_noactive;
	   }
	  }
	}
