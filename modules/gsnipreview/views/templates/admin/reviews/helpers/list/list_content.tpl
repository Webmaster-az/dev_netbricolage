    ...
    {block name="td_content"}
        {if isset($params.type_custom) && $params.type_custom == 'is_abuse'}
            ...
            {if is_array($tr[$key])}
                ...
                <span  class="label-tooltip" data-original-title="{$tr[$key]['alt']|escape:'htmlall':'UTF-8'}" data-toggle="tooltip">
                    <a href="javascript:void(0)" onclick="gsnipreview_list({$tr['id']|escape:'htmlall':'UTF-8'},'abuse',0,'{$params.token|escape:'htmlall':'UTF-8'}');" style="text-decoration:none">
        ...
        {elseif isset($params.type_custom) && $params.type_custom == 'is_changed'}
            ...
            {if is_array($tr[$key])}
                <span id="changeditem{$tr['id']|escape:'htmlall':'UTF-8'}">
                    ...
                    <span class="label-tooltip" data-original-title="{$tr[$key]['alt']|escape:'htmlall':'UTF-8'}" data-toggle="tooltip">
                    <a href="javascript:void(0)" onclick="gsnipreview_list({$tr['id']|escape:'htmlall':'UTF-8'},'changed',{$tr[$key]['value']|escape:'htmlall':'UTF-8'},'{$params.token|escape:'htmlall':'UTF-8'}');" style="text-decoration:none">
                        <img src="../img/admin/{$tr[$key]['src']|escape:'htmlall':'UTF-8'}" alt="{$tr[$key]['alt']|escape:'htmlall':'UTF-8'}" title="{$tr[$key]['alt']|escape:'htmlall':'UTF-8'}" />
                    </a>
        ...
        {elseif isset($params.type_custom) && $params.type_custom == 'is_active'}
            ...
            <span id="activeitem{$tr['id']|escape:'htmlall':'UTF-8'}">
                    <span class="label-tooltip" data-original-title="{l s='Click here to activate or deactivate review on your site' mod='gsnipreview'}" data-toggle="tooltip">
                    <a href="javascript:void(0)" onclick="gsnipreview_list({$tr['id']|escape:'htmlall':'UTF-8'},'active',{$tr[$key]|escape:'htmlall':'UTF-8'},'');" style="text-decoration:none">
                        <img src="../img/admin/../../modules/gsnipreview/views/img/{if $tr[$key] == 1}ok.gif{else}no_ok.gif{/if}"  />
                    </a>
                </span>
            </span>
        ...
        {elseif isset($params.type_custom) && $params.type_custom == 'title_review'}
            {if isset($tr[$key])}
                <span class="label-tooltip" data-original-title="{l s='Click here to see review on your site' mod='gsnipreview'}" data-toggle="tooltip">
                    {*$link->getModuleLink('gsnipreview', 'review', [], true, {$tr.id_lang}, {$tr.id_shop})}?rid={$tr['id']*}

                    <a href="{$link->getModuleLink('gsnipreview', 'review', [], true, {$tr.id_lang|escape:'htmlall':'UTF-8'}, {$tr.id_shop|escape:'htmlall':'UTF-8'})|escape:'htmlall':'UTF-8'}{if $params.is_rewrite == 1}?{else}&{/if}rid={$tr['id']|escape:'htmlall':'UTF-8'}"  style="text-decoration:underline" target="_blank">
                        {$tr[$key]|escape:'htmlall':'UTF-8'}
                    </a>
                </span>
            {/if}
        ...
        {elseif isset($params.type_custom) && $params.type_custom == 'id_product'}
            {if isset($tr[$key])}
                <span class="label-tooltip" data-original-title="{l s='Click here to see product on your site' mod='gsnipreview'}" data-toggle="tooltip">
