...
{if $gsnipreviewhooktodisplay == "extra_left"}

<div class="clear-gsnipreview"></div>

<div class="{if $gsnipreviewis16 == 1}gsniprev-block-16{else}gsniprev-block{/if}">
<b class="title-rating-block">
    <img src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/gsnipreview/views/img/{$gsnipreviewactivestar|escape:'htmlall':'UTF-8'}" class="title-rating-one-star" alt="{l s='Total Rating' mod='gsnipreview'}" />&nbsp;{l s='Total Rating' mod='gsnipreview'}</b><span class="ratings-block-punct">:</span>
<br/><br/>
...
{$gsnipreviewextraleft|escape:'htmlall':'UTF-8'}

    {if $gsnipreviewpinvis_on == 1 && $gsnipreview_extraLeft == 'extraLeft'}
