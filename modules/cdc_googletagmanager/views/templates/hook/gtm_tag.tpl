...
<script data-keepinline="true">
    var ajaxGetProductUrl = '{if !empty($ajaxGetProductUrl)}{$ajaxGetProductUrl|escape:'htmlall':'UTF-8'}{/if}';
...
'{/literal}{$google_script_server_url|escape:'htmlall':'UTF-8'}{literal}?id='+i+dl;f.parentNode.insertBefore(j,f);
