...
<div class="panel">
    ...
    <form id="pagecache_form_cron" action="{$request_uri|escape:'html':'UTF-8'}" method="post" onsubmit='return confirm("{l s='WARNING! This will replace the configuration of selected shops, are you sure?' mod='pagecache'}");'>
