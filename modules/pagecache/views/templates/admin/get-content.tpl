...
<style>
    ...
    #content.bootstrap #pagecachecfg .panel { padding: 16px}
            ...
            <div class="col-md-4 col-lg-3 col-xl-2 jprestamenu">
                <div class="panel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li id="lilicense" role="presentation" {if $pctab eq 'license'}class="active"{/if}><a href="#tablicense" onclick="displayTab('license');return true;">{if $avec_bootstrap}<i class="icon-key"></i>{else}<img width="16" height="16" src="../img/admin/htaccess.gif" alt=""/>{/if}&nbsp;{l s='License' mod='pagecache'}</a></li>
                        <li id="licachewarmer" role="presentation" {if $pctab eq 'cachewarmer'}class="active"{/if}><a href="#tabcachewarmer" onclick="displayTab('cachewarmer');return true;">{if $avec_bootstrap}<i class="icon-fire"></i>{else}<img width="16" height="16" src="../img/admin/quick.gif" alt=""/>{/if}&nbsp;{l s='JPresta Cache Warmer' mod='pagecache'}</a></li>
