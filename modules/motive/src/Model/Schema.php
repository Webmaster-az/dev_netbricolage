...
class Schema
{
    ...
    public $fields;
    /** @var SchemaProductLabel[] Schema's field labels */
     ...
     * @param Field[] $fields
     * @param SchemaProductLabel[] $product_labels
     *
     * @return Schema
     */
    public static function build(Metadata $metadata, array $fields = [], array $product_labels = [])
    {
        $schema = new static();
