...
<div id="refund" class="panel">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="input-group">
                <button type="button" class="btn btn-success btn-lg" id="capture">
                    {l s='Capture the transaction' mod='hipay_professional'}
                </button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <div class="input-group">
                <div id="hipay-loading" style="display:none;">
                    <img src="/modules/hipay_professional/views/img/loading.gif"/>
                </div>
            </div>
        </div>
    </div>
