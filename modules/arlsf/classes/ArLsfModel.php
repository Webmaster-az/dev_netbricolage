...
abstract class ArLsfModel
{
                                    ...
                                    if (Validate::$method($v)) {
                                        ...
                                        if ($addErrors) {
                                            if (isset($validator['message'])) {
                                                ...
                                                $this->addError($attr, sprintf($this->l('Incorrect "%s" value', 'ArLsfModel'), $this->getAttributeLabel($attr)));
                                            }
                                        }
                                        $valid = false;
                                    }
    ...
    {
        $multi = $this->getMultipleSelect($attribute) && $multi? '[]' : '';
            ...
            if ($this->getAttributeType($attr) == 'switch') {
                $config[$name]['values'] = array(
                    array(
                        'id' => 'active_on',
                        'value' => true,
                        'label' => $this->l('Enabled', 'ArLsfModel'),
                    ),
                    array(
                        'id' => 'active_off',
                        'value' => false,
                        'label' => $this->l('Disabled', 'ArLsfModel'),
                    )
                );
            }
