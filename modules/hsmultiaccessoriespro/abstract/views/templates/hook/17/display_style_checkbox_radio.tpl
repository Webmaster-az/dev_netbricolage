...
{assign var=image_width value=$product.cover.large.width}
...
<div id="product_list_accessory_{$group.id_accessory_group|intval}" class="accessorygroup clear">
    {foreach from=$accessories_groups[$group.id_accessory_group] item=accessory key=key}
        ...
        <div class="clearfix pc-accessory-row"> 
            {if $is_product_page}
                <div class="pc-accessories-checkbox">
            ...
            <div>
                <form action="{$urls.pages.cart}" class="add_accessory_to_cart">
                    ...
                    {* {if $accessory.is_available_when_out_of_stock}
