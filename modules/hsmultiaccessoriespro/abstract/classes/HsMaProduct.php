...
class HsMaProduct extends Product
{
     ...
     * @return boolean
     */
    public static function copyAccessories($from_product, $to_product)
    {
        $flag        = true;
        $accessories = self::getAccessoriesDiff($from_product, $to_product);
     ...
     * )<pre />
     */
    protected static function getAccessoriesDiff($from_product, $to_product)
    {
        $sql = new DbQuery();
