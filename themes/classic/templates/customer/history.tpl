      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            ...
            <th scope="row"><a href="{$order.details.details_url}" data-link-action="view-order-details">{$order.details.reference}</a></th>
            ...
            <td class="text-sm-center order-actions">
              {if $order.details.reorder_url}
                <a href="{$order.details.reorder_url}">{l s='Reorder' d='Shop.Theme.Actions'}
