        ...
        {foreach $order.subtotals as $line}
          {if $line.value}
            <tr class="text-xs-right line-{$line.type}">
              <td style="font-weight: bold;" colspan="3">{$line.label}</td>
              <td style="border-left: 1px solid;">{$line.value}</td>
            </tr>
          {/if}
        {/foreach}
        <tr class="text-xs-right line-{$order.totals.total.type}">
          <td style="font-weight: bold;" colspan="3">{$order.totals.total.label}</td>
          <td style="border-left: 1px solid;">{$order.totals.total.value}</td>
        </tr>
      </tfoot>
    </table>
  </div>
