...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<thead>
		<tr>
			<th class="product header small" width="7%"></th>
			<th class="product header small" width="20%">{l s='Reference' d='Shop.Pdf' pdf='true'}</th>
			<th class="product header small" width="67%">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
		...
		{foreach $order_details as $order_detail}
			...
			<tr class="product {$bgcolor_class}">
				...
				<td style="text-align: center;">
					...
					{/if}
					<br>
					{if $order_detail.product_ean13}
						{$order_detail.product_ean13}
					{/if}
				</td>
				<td class="product left">
					{$order_detail.product_name|replace:' - ':'<br>'}
				</td>
